...
export default function Artists({stylists}) {
  ...
  return (
    <div className="relative">
      <div className="absolute -top-20 right-0 bg-primary opacity-10 h-[25rem] sm:h-[50rem] w-1/2 sm:w-1/3  z-10 "></div>
      <div className="relative mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
        <div className="flex flex-col sm:flex-row gap-5 ">
          <div className="flex flex-col sm:w-1/2 ">
            <div className="text-sm mb-8 font-bold">ABOUT US</div>
            <h1 className="font-primary text-4xl tracking-tight font-extrabold text-gray-900 dark:text-gray-500 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl"> HeadBetter is where the heart is </h1>
          </div>
          <div className="flex flex-col sm:w-1/2 leading-7 ">
            ...
            <button className="mt-8 text-gray-100 text-left bg-primary hover:bg-primary-dark p-2 rounded-lg w-fit ">
